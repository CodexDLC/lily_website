...
This section contains the design system, UI kit, and user flow documentation for the Lily Beauty Salon project.

## 🗺️ Module Map

| Component | Description |
|:---|:---|
| **[🎨 Identity](./identity.md)** | Color palette, typography, and branding rules |
| **[📐 Layout & Grid](./layout_navigation.md)** | Grid system, header/footer architecture, and responsiveness |
| **[🧩 UI Components](./ui_components.md)** | Buttons, cards, forms, and other reusable elements |
