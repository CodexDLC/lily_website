...
def test_adapter_returns_availability_for_active_master(master, site_settings_obj, booking_settings):
...
def test_work_days_property_populated_from_working_days(site_settings_obj, booking_settings, category):
...
def test_confirmed_appointment_blocks_slots(master, client_obj, service, site_settings_obj, booking_settings):
...
def test_day_off_returns_no_availability(master, site_settings_obj, booking_settings):
...
def test_dirty_seconds_cleaned_by_adapter(master, client_obj, service, site_settings_obj, booking_settings):
