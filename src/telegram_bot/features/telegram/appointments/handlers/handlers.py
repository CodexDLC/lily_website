...
from src.telegram_bot.features.telegram.appointments.resources.callbacks import AppointmentsCallback
from src.telegram_bot.services.director.director import Director

router = Router(name="appointments_router")


@router.callback_query(AppointmentsCallback.filter())
async def handle_action(
    call: CallbackQuery,
    callback_data: AppointmentsCallback,
    state,
    ...
    orchestrator = container.features["appointments"]
