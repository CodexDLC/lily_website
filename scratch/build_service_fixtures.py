...
def make(pk, *, category, slug, order,
         name_de, name_en, name_ru, name_uk,
         price, duration,
         duration_info_de, duration_info_en, duration_info_ru, duration_info_uk,
         description_de, description_en, description_ru, description_uk,
         content_de, content_en, content_ru, content_uk,
         seo_title_de, seo_title_en, seo_title_ru, seo_title_uk,
         seo_desc_de, seo_desc_en, seo_desc_ru, seo_desc_uk,
         is_hit=False, is_addon=False, parallel_ok=True, parallel_group="",
         min_gap_after_minutes=0, price_info_de="", price_info_en="", price_info_ru="", price_info_uk=""):
    return svc(pk, {
...
nails.append(make(
    pk=45, category=2, slug="nail-extensions-long-4-6", order=75,
...
e["fields"]["price"] = "65.00"; cosmetology.append(e)  # 50 -> 65
...
e["fields"]["price"] = "50.00"; cosmetology.append(e)  # 40 -> 50
e = deepcopy(existing[27])  # Kryotherapie
e["fields"]["price"] = "50.00"; cosmetology.append(e)  # 35 -> 50
cosmetology.append(deepcopy(existing[28]))  # Fruchtsäurepeeling 35

# New cosmetology services (pk 50-64) — 14 items
cosmetology.append(make(
    pk=50, category=3, slug="cosmetology-cleansing-peel", order=15,
    ...
    price=80.00, duration=60,
    duration_info_de="60 Min", duration_info_en="60 min", duration_info_ru="60 мин", duration_info_uk="60 хв",
...
cosmetology.append(make(
    pk=51, category=3, slug="cosmetology-carboxy-neck-decolte", order=55,
...
cosmetology.append(make(
    pk=52, category=3, slug="cosmetology-cleansing-carboxy", order=25,
    ...
    price=100.00, duration=90,
    duration_info_de="90 Min", duration_info_en="90 min", duration_info_ru="90 мин", duration_info_uk="90 хв",
...
cosmetology.append(make(
    pk=53, category=3, slug="cosmetology-enzyme-therapy", order=80,
    name_de="Enzymtherapie",
    name_en="Enzyme Therapy",
    name_ru="Ферментная терапия",
    name_uk="Ферментна терапія",
    price=75.00, duration=50,
    duration_info_de="50 Min", duration_info_en="50 min", duration_info_ru="50 мин", duration_info_uk="50 хв",
...
cosmetology.append(make(
    pk=54, category=3, slug="cosmetology-anti-acne", order=85,
    ...
    price=55.00, duration=45,
    duration_info_de="45 Min", duration_info_en="45 min", duration_info_ru="45 мин", duration_info_uk="45 хв",
...
cosmetology.append(make(
    pk=55, category=3, slug="cosmetology-line-correction", order=90,
    ...
    price=50.00, duration=30,
    duration_info_de="30 Min", duration_info_en="30 min", duration_info_ru="30 мин", duration_info_uk="30 хв",
...
cosmetology.append(make(
    pk=56, category=3, slug="cosmetology-nuance-care", order=95,
...
cosmetology.append(make(
    pk=57, category=3, slug="cosmetology-rf-lifting", order=100,
    name_de="HF-Hebetechnik (RF-Lifting)",
    name_en="RF Lifting",
    name_ru="RF-лифтинг",
    name_uk="RF-ліфтинг",
    price=40.00, duration=15,
    duration_info_de="15 Min", duration_info_en="15 min", duration_info_ru="15 мин", duration_info_uk="15 хв",
...
cosmetology.append(make(
    pk=58, category=3, slug="cosmetology-oxygen-meso", order=105,
...
cosmetology.append(make(
    pk=59, category=3, slug="cosmetology-peeling-surface", order=72,
...
cosmetology.append(make(
    pk=60, category=3, slug="cosmetology-peeling-medium", order=74,
...
cosmetology.append(make(
    pk=62, category=3, slug="cosmetology-face-massage", order=115,
...
cosmetology.append(make(
    pk=64, category=3, slug="cosmetology-mens-facial", order=125,
...
brows_lashes.append(make(
    pk=46, category=4, slug="lashes-effect-surcharge", order=100,
    name_de="Effektzuschlag",
    name_en="Effect Surcharge",
    name_ru="Доплата за эффект",
    name_uk="Доплата за ефект",
    price=15.00, duration=5,
    duration_info_de="5 Min", duration_info_en="5 min", duration_info_ru="5 мин", duration_info_uk="5 хв",
...
massage.append(make(
    pk=47, category=5, slug="massage-legs-zone", order=40,
    name_de="Beinmassage",
    name_en="Legs Massage",
    name_ru="Массаж ног",
    name_uk="Масаж ніг",
    price=35.00, duration=30,
    duration_info_de="30 Min", duration_info_en="30 min", duration_info_ru="30 мин", duration_info_uk="30 хв",
...
massage.append(make(
    pk=48, category=5, slug="massage-hips-zone", order=50,
    name_de="Hüftmassage",
...
massage.append(make(
    pk=49, category=5, slug="massage-belly-zone", order=60,
...
def relabel(pk_src, *, slug, order, name_de, name_en, name_ru, name_uk,
            duration=None, price=None,
            duration_info_de=None, duration_info_en=None, duration_info_ru=None, duration_info_uk=None):
...
depilation.append(relabel(
    35, slug="depilation-w-upper-lip", order=100,
    ...
    duration=10,
    duration_info_de="10 Min", duration_info_en="10 min", duration_info_ru="10 мин", duration_info_uk="10 хв",
))
# pk=36 Achseln — Damen
depilation.append(relabel(
    36, slug="depilation-w-axilla", order=110,
...
depilation.append(relabel(
    37, slug="depilation-w-bikini-classic", order=170,
...
depilation.append(relabel(
    38, slug="depilation-w-bikini-hollywood", order=180,
...
depilation.append(relabel(
    40, slug="depilation-m-back", order=240,
    ...
    duration=25,
    duration_info_de="25 Min", duration_info_en="25 min", duration_info_ru="25 мин", duration_info_uk="25 хв",
))
...
def dep_new(pk, *, slug, order, gender, zone_de, zone_en, zone_ru, zone_uk, price, duration):
    ...
    return make(
        pk=pk, category=6, slug=slug, order=order,
...
# Women — new
depilation.append(dep_new(70, slug="depilation-w-face", order=105, gender="w",
    zone_de="Gesichtsbereich", zone_en="Face area", zone_ru="Зона лица", zone_uk="Зона обличчя",
    price=10.00, duration=15))
depilation.append(dep_new(71, slug="depilation-w-forearm", order=120, gender="w",
    zone_de="Unterarm", zone_en="Forearm", zone_ru="Руки до локтя", zone_uk="Руки до ліктя",
    price=15.00, duration=15))
depilation.append(dep_new(72, slug="depilation-w-arms-full", order=125, gender="w",
    zone_de="Arme vollständig", zone_en="Full arms", zone_ru="Руки полностью", zone_uk="Руки повністю",
    price=20.00, duration=25))
depilation.append(dep_new(73, slug="depilation-w-belly", order=130, gender="w",
    zone_de="Bauch", zone_en="Belly", zone_ru="Живот", zone_uk="Живіт",
    price=10.00, duration=15))
depilation.append(dep_new(74, slug="depilation-w-lower-legs", order=140, gender="w",
    zone_de="Unterschenkel", zone_en="Lower legs", zone_ru="Голени", zone_uk="Гомілки",
    price=15.00, duration=30))
depilation.append(dep_new(75, slug="depilation-w-legs-full", order=150, gender="w",
    zone_de="Beine vollständig", zone_en="Full legs", zone_ru="Ноги полностью", zone_uk="Ноги повністю",
    price=35.00, duration=45))
depilation.append(dep_new(76, slug="depilation-w-hips", order=160, gender="w",
    zone_de="Hüften", zone_en="Hips", zone_ru="Бёдра", zone_uk="Стегна",
    price=20.00, duration=30))

# Men — new
depilation.append(dep_new(77, slug="depilation-m-axilla", order=210, gender="m",
    zone_de="Achselhöhlen", zone_en="Armpits", zone_ru="Подмышки", zone_uk="Пахви",
    price=15.00, duration=15))
depilation.append(dep_new(78, slug="depilation-m-shoulders", order=220, gender="m",
    zone_de="Schultern", zone_en="Shoulders", zone_ru="Плечи", zone_uk="Плечі",
    price=30.00, duration=15))
depilation.append(dep_new(79, slug="depilation-m-chest-belly", order=230, gender="m",
    zone_de="Brust & Bauch", zone_en="Chest & Belly", zone_ru="Грудь и живот", zone_uk="Груди та живіт",
    price=35.00, duration=20))
depilation.append(dep_new(80, slug="depilation-m-buttocks", order=250, gender="m",
    zone_de="Pobacken", zone_en="Buttocks", zone_ru="Ягодицы", zone_uk="Сідниці",
    price=20.00, duration=20))
depilation.append(dep_new(81, slug="depilation-m-bikini-brazilian", order=260, gender="m",
    zone_de="Brasilianischer Bikini", zone_en="Brazilian bikini", zone_ru="Глубокое бикини", zone_uk="Глибоке бікіні",
    price=50.00, duration=30))
...
for i, s in enumerate(cosmo_ids):
    for t in cosmo_ids:
        if s == t:
            continue
...
for s in ext_ids:
    for t in ext_ids:
        ...
        filtered.append({
            "model": "main.serviceconflictrule",
            "pk": next_pk,
            "fields": {"source": s, "target": t, "rule_type": "replaces", "is_active": True, "note": "nails-46-auto"},
        })
        next_pk += 1
